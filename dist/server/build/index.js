...
exports.default = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(dir) {
    ...
    var buildId, tempDir, buildDir, compiler, stats;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            buildId = _uuid2.default.v4();
            tempDir = (0, _os.tmpdir)();
            buildDir = (0, _path.join)(tempDir, _uuid2.default.v4());
            _context.prev = 3;
            _context.next = 6;
            return _fs2.default.access(tempDir, _fs2.default.constants.W_OK);
