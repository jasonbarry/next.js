    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            dir = (0, _fs.realpathSync)((0, _path.resolve)(dir));
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 3;
                        return (0, _globPromise2.default)(config.pagesGlobPattern, { cwd: dir });
                      ...
                      case 3:
                        ...
                        for (_iterator = (0, _getIterator3.default)(devPages); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                          ...
                          entries[(0, _path.join)('bundles', p.replace('.jsx', '.js'))] = ['./' + p + '?entry'];
                        }
                        _context.next = 17;
                        break;
                      ...
                      case 27:
                        ...
                        for (_iterator2 = (0, _getIterator3.default)(pages); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                          ...
                          entries[(0, _path.join)('bundles', _p.replace('.jsx', '.js'))] = ['./' + _p + '?entry'];
                        }
                        _context.next = 38;
                        break;
            ...
            rules = (dev ? [{
              ...
              options: {
                ...
                interpolateName: function interpolateName(name) {
                  return name.replace('.jsx', '.js');
                },
                validateFileName: function validateFileName(file) {
                  var cases = [{ from: '.js', to: '.jsx' }, { from: '.jsx', to: '.js' }];
                  ...
                  try {
                    for (var _iterator4 = (0, _getIterator3.default)(cases), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                      ...
                      var filePath = file.slice(0, -from.length) + to;
                ...
                transform: function transform(_ref4) {
                  ...
                  var transpiled = babelCore.transform(content, {
                    ...
                    plugins: [require.resolve((0, _path.join)(__dirname, './babel/plugins/remove-dotjsx-from-import.js')), [require.resolve('babel-plugin-transform-es2015-modules-commonjs')], [require.resolve('babel-plugin-module-resolver'), {
                      alias: {
